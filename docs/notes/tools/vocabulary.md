...
|                                 |                    | be part of a boot-camp      | 新兵训练营的一员     |
...
| rookie, newbie, noob, newcomers | 菜鸟，新手         | the aggregated results      | 聚合结果             |
...
| terminology                     | 术语               | tailor Chrome functionality | 定制功能             |
| threshold                       | 临界点，阈值       |                             |                      |
| truthiness                      | 真实性             |                             |                      |
...
| Also of note,                  | 同样值得注意的是         | be a separate operation to                | 单独操作                   |
| As i alluded                   | 正如我提到的             | be named after                            | 以…命名                    |
...
| get passed to                  | 传给                     | get assigned a namespace                  | 被分配一个命名空间         |
...
| case by case                   | 个案的; 具体问题具体分析 | In the interests of clarity and brevity,  | 为了清晰和简洁             |
...
| take this with a grain of salt | 对此持保留意见           |                                           |                            |
